...
const VietnameseLogo: React.FC<ILogoProps> = ({ size }) => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' id='flag-icons-vn' viewBox='0 0 640 480' width={size} height={size}>
      <defs>
        <clipPath id='vn-a'>
