      ...
      <div className='mx-auto max-w-screen-xl space-y-8 overflow-hidden px-4 py-12 sm:px-6 lg:px-8'>
        ...
        <div className='mt-8 flex justify-center space-x-6'>
          {socialItems.map((socialItem, index) => (
            <Link key={index} to={socialItem.link} className='text-gray-200 hover:text-gray-400'>
              <span className='sr-only'>{socialItem.text}</span>
              {socialItem.svg}
            </Link>
          ))}
        </div>
